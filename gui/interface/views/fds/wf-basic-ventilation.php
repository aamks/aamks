...
<!-- {{{Lista elementow VENT -->
		<div class="list">
			...
			<div class="list-items" scrollbar="{axis:'y', alwaysVisible:true, autoUpdate:true}" scrollname="vent">
				<div class="list-item" ng-repeat="ventItem in ventilation.vents|slice:ui.ventilation.vents.begin:(ui.ventilation.vents.begin+listRange)">
			...
			<div class="list-bottom" ng-if="ventilation.vents.length>listRange">
				<div  class="list-controls">
					<i class="material-icons" ng-click="functions.vent.decreaseRange()">chevron_left</i>
					<p>{{ui.ventilation.vent.begin}}-{{ui.ventilation.vent.begin+listRange>ventilation.vents.length ? ventilation.vents.length:ui.ventilation.vent.begin+listRange}}</p>
			...
			<div ng-if="vent && currentVentList.type=='file'">
				...
				<div class="form-row">
					<div class="form-column">
						<label>Surface:</label>
						<div class="field-container">
							<select ng-change="vent.changeSurfID('{{vent.surf.surf_id.id}}', ventilation.surfs)" ng-model="vent.surf.surf_id" ng-options="surf.id for surf in ventilation.surfs" chosen disable-search="true"><option value="" selected>No SURF</option></select>
						</div>
					</div>
				</div>
			</div>
...
<!-- {{{Lista elementow SURF -->
		<div class="list">
			...
			<div class="list-items" scrollbar="{axis:'y', alwaysVisible:true, autoUpdate:true}" scrollname="surfvent">
				<div class="list-item" ng-repeat="surfItem in ventilation.surfs|slice:ui.ventilation.surfs.begin:(ui.ventilation.surfs.begin+listRange)">
			...
			<div class="list-bottom" ng-if="ventilation.surfs.length>listRange">
				<div  class="list-controls">
					<i class="material-icons" ng-click="functions.surf.decreaseRange()">chevron_left</i>
					<p>{{ui.ventilation.surf.begin}}-{{ui.ventilation.surf.begin+listRange>ventilation.surfs.length ? ventilation.surfs.length:ui.ventilation.surf.begin+listRange}}</p>
			...
			<div ng-if="surf && currentSurfList.type=='file'">
				...
				<div class="form-row">
					...
					<div class="form-column" ng-if="surf.flow.type=='velocity'">
						...
						<div class="field-container">
							<input class="short" type="text" ng-model-options="{getterSetter:true, updateOn:'blur'}" ng-model="surf.flow.set_velocity" pu-elastic-input/> 
					...
					<div class="form-column" ng-if="surf.flow.type=='volumeFlow'">
						...
						<div class="field-container">
							<input class="short" type="text"  ng-model-options="{getterSetter:true, updateOn:'blur'}" ng-model="surf.flow.set_volume_flow" pu-elastic-input/> 
							<katex bind="globalAmpers.surf.volume_flow.units"></katex>
							<input class="ml+ short" type="text"  ng-model-options="{getterSetter:true, updateOn:'blur'}" ng-model="surf.flow.set_volume_flow_per_hour" pu-elastic-input /> 
							<katex>{m^3}/h</unit>
						</div>
					</div>
					<div class="form-column" ng-if="surf.flow.type=='massFlow'">
						...
						<div class="field-container">
							<input class="short" type="text"  ng-model-options="{getterSetter:true, updateOn:'blur'}" ng-model="surf.flow.set_mass_flow" pu-elastic-input/> 
...
<!-- {{{Lista elementow biblioteki -->
		<div class="lib-wrapper">
			<div class="lib-drawer" ng-class="ui.ventilation.surf.lib=='closed' ? 'closed' : 'open'">
				...
				<div class="lib-area">
					<div class="list">
						...
						<div class="list-items" scrollbar="{axis:'y', alwaysVisible:true, autoUpdate:true}" scrollname="libSpecie">
							<div class="list-item" ng-repeat="surfItem in lib.ventsurfs|slice:ui.ventilation.libSurf.begin:(ui.ventilation.libSurf.begin+listRange)">
						...
						<div class="list-bottom" ng-if="lib.ventsurfs.length>listRange">
							<div  class="list-controls">
								...
								<p>{{ui.ventilation.libSurf.begin}}-{{ui.ventilation.libSurf.begin+listRange>lib.ventsurfs.length ? lib.ventsurfs.length:ui.ventilation.libSurf.begin+listRange}}</p>
...
<!--}}}-->
<!-- {{{Pomoc -->
			<div class="help-drawer" ng-class="ui.ventilation.surf.help=='closed' ? 'closed' : 'open'">

...
export class General {
    ...
    private _time:object; 
    private _misc:object;
	...
	public get head(): object {
		return this._head;
	}

	public set head(value: object) {
		this._head = value;
	}

	public get time(): object {
		return this._time;
	}

	public set time(value: object) {
		this._time = value;
	}

	public get misc(): object {
		return this._misc;
	}

	public set misc(value: object) {
		this._misc = value;
	}

	public get init(): object {
		return this._init;
	}

	public set init(value: object) {
		this._init = value;
    }

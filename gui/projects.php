...
function new_scenario() { # {{{
	...
	if (!mkdir(implode("/", array($_SESSION['main']['user_home'],$_POST['project_name'],$_POST['new_scenario'])), 0776, true)) {
...
function new_project() { # {{{
	...
	if (!mkdir(implode("/", array($_SESSION['main']['user_home'],$_POST['new_project'])), 0776, true)) {

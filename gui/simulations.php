...
function show_pictures() {/*{{{*/
	...
	echo "<br>$z";
	$counter = 1;
	$pictures_list = array(array('pie_fault','The share of scenario with failure of safety systems'), array('lossesd','Number of scenarios with fatalities with respect to number of people affected'), array('lossesh','Number of scenarios with heavy injured with respect to number of people affected'), array('lossesl','Number of scenarios with heavy injured with respect to number of people affected'), array('lossesn','Number of scenarios with neglegibly injured with respect to number of people affected'), array('ccdf','FN curves'), array('dcbe','Cumulative distribution function of ASET'), array('wcbe','Cumulative distribution function of RSET'), array('height','Cumulative distribution function of minimal hot layer height'), array('hgt_cor','Cumulative distribution function of minimal hot layer height on the evacuation routes'), array('temp','Cumulative distribution function of maximal temperature'), array('vis','Cumulative distribution function of the minimal visibility'), array('vis_cor','Cumulative distribution function of the minimal visibility on the evacuation routes'), array('tree_F','Event tree for fatalities due to toxic gases'), array('tree_M','Event tree for casulties due toxic gases'), array('tree_steel','Event for construction stability'));

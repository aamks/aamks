...
class TestDrawAndLog(TestCase):
    def setUp(self) -> None:
        ...
        def side_effect(query, args=None):
            ...
            if query.startswith("SELECT * FROM aamks_geom WHERE type_tri='DOOR'"):
                return [OrderedDict([('name', 'd1'), ('floor', '0'), ('global_type_id', 1), ('hvent_room_seq', 1), ('vvent_room_seq', None), ('type_pri', 'HVENT'), ('type_sec', 'DOOR'), ('type_tri', 'DOOR'), ('x0', 984), ('y0', 719), ('z0', 0), ('width', 32), ('depth', 86), ('height', 200), ('cfast_width', 90), ('sill', 0), ('face', 'RIGHT'), ('face_offset', 304.0), ('vent_from', 1), ('vent_to', 2), ('material_ceiling', 'concrete'), ('material_floor', 'concrete'), ('material_wall', 'concrete'), ('heat_detectors', 0), ('smoke_detectors', 0), ('sprinklers', 0), ('is_vertical', 1), ('vent_from_name', 'r1'), ('vent_to_name', 'c2'), ('how_much_open', None), ('room_area', None), ('x1', 1016), ('y1', 805), ('z1', 200), ('center_x', 1000), ('center_y', 760), ('center_z', 100), ('fire_model_ignore', 0), ('mvent_throughput', None), ('exit_type', 'auto'), ('room_enter', None), ('evacuees_density', None), ('terminal_door', None), ('points', '[[984, 715], [1016, 715], [1016, 805], [984, 805]]'), ('origin_room', None), ('orig_type', 'DOOR'), ('has_door', None), ('teleport_from', None), ('teleport_to', None), ('adjacents', None), ('stair_direction', None), ('exit_weight', None), ('room_exits_weights', None)]),
                        OrderedDict([('name', 'd2'), ('floor', '0'), ('global_type_id', 1), ('hvent_room_seq', 1), ('vvent_room_seq', None), ('type_pri', 'HVENT'), ('type_sec', 'DOOR'), ('type_tri', 'DOOR'), ('x0', 984), ('y0', 719), ('z0', 0), ('width', 32), ('depth', 86), ('height', 200), ('cfast_width', 90), ('sill', 0), ('face', 'RIGHT'), ('face_offset', 304.0), ('vent_from', 1), ('vent_to', 2), ('material_ceiling', 'concrete'), ('material_floor', 'concrete'), ('material_wall', 'concrete'), ('heat_detectors', 0), ('smoke_detectors', 0), ('sprinklers', 0), ('is_vertical', 1), ('vent_from_name', 'r1'), ('vent_to_name', 'c2'), ('how_much_open', None), ('room_area', None), ('x1', 1016), ('y1', 805), ('z1', 200), ('center_x', 1000), ('center_y', 760), ('center_z', 100), ('fire_model_ignore', 0), ('mvent_throughput', None), ('exit_type', 'auto'), ('room_enter', None), ('evacuees_density', None), ('terminal_door', None), ('points', '[[984, 715], [1016, 715], [1016, 805], [984, 805]]'), ('origin_room', None), ('orig_type', 'DOOR'), ('has_door', None), ('teleport_from', None), ('teleport_to', None), ('adjacents', None), ('stair_direction', None), ('exit_weight', None), ('room_exits_weights', None)]),
                        OrderedDict([('name', 'z3'), ('floor', '0'), ('global_type_id', 1), ('hvent_room_seq', 1), ('vvent_room_seq', None), ('type_pri', 'HVENT'), ('type_sec', 'HOLE'), ('type_tri', 'DOOR'), ('x0', 984), ('y0', 719), ('z0', 0), ('width', 32), ('depth', 86), ('height', 200), ('cfast_width', 90), ('sill', 0), ('face', 'RIGHT'), ('face_offset', 304.0), ('vent_from', 1), ('vent_to', 3), ('material_ceiling', 'concrete'), ('material_floor', 'concrete'), ('material_wall', 'concrete'), ('heat_detectors', 0), ('smoke_detectors', 0), ('sprinklers', 0), ('is_vertical', 1), ('vent_from_name', 'r1'), ('vent_to_name', 'r3'), ('how_much_open', None), ('room_area', None), ('x1', 1016), ('y1', 805), ('z1', 200), ('center_x', 1000), ('center_y', 760), ('center_z', 100), ('fire_model_ignore', 0), ('mvent_throughput', None), ('exit_type', 'auto'), ('room_enter', None), ('evacuees_density', None), ('terminal_door', None), ('points', '[[984, 715], [1016, 715], [1016, 805], [984, 805]]'), ('origin_room', None), ('orig_type', 'DOOR'), ('has_door', None), ('teleport_from', None), ('teleport_to', None), ('adjacents', None), ('stair_direction', None), ('exit_weight', None), ('room_exits_weights', None)])]
    ...
    def test_draw_doors_and_holes_opening(self, mock_binomial, mock_fire):
        ...
        mock_fire.return_value.f_id = 'f3'

        self.draw._draw_doors_and_holes_opening()

        self.assertEqual(self.draw.sections['DOORS'][0], {'TYPE': 'WALL', 'ID': 'd1', 'COMP_IDS': ["'r1'", "'c2'"], 'WIDTH': 0.9, 'TOP': 2.0, 'BOTTOM': 0.0, 'OFFSET': 3.04, 'FACE': 'RIGHT', 'CRITERION': ["'TIME'", 'T='+",".join(str(x) for x in range(0, self.draw.conf['simulation_time'])) , 'F='+",".join("0" for _ in range(self.draw.conf['simulation_time']))]})
        self.assertEqual(self.draw.sections['DOORS'][1], {'TYPE': 'WALL', 'ID': 'd2', 'COMP_IDS': ["'r1'", "'c2'"], 'WIDTH': 0.9, 'TOP': 2.0, 'BOTTOM': 0.0, 'OFFSET': 3.04, 'FACE': 'RIGHT', 'CRITERION': ["'TIME'", 'T='+",".join(str(x) for x in range(0, self.draw.conf['simulation_time'])) , 'F='+",".join("1" for _ in range(self.draw.conf['simulation_time']))]})
        self.assertEqual(self.draw.sections['DOORS'][2], {'TYPE': 'WALL', 'ID': 'z3', 'COMP_IDS': ["'r1'", "'r3'"], 'WIDTH': 0.9, 'TOP': 2.0, 'BOTTOM': 0.0, 'OFFSET': 3.04, 'FACE': 'RIGHT', 'CRITERION': ["'TIME'", 'T = 0', 'F = 1']})
        self.assertEqual(self.draw.data_for_psql['123']['door'], [0, 1])
        self.assertEqual(self.draw._fire_openings, [(0.32, 2.0, 1)])
